  ...
  <div>
    <div class="search-filter__wrapper uk-position-relative z-index-20">
      <form class="uk-flex uk-height-1-1" @submit.prevent="formSubmit">
        ...
        <div class="uk-background-default input__block uk-height-1-1 uk-width-1-2 uk-visible@m">
          ...
          <div uk-dropdown="mode: click" class="uk-border-rounded">
            <div class="label_wrapper">
              <div class="label label__item uk-margin-small-bottom">
                <label>
                  <input class="uk-checkbox" type="checkbox" :value="1" name="materials" v-model="filterTools.materials">
                  <span class="uk-margin-small-left">Кирпич</span>
                </label>
              </div>
              <div class="label label__item uk-margin-small-bottom">
                <label>
                  <input class="uk-checkbox" type="checkbox" :value="2" name="materials" v-model="filterTools.materials">
                  <span class="uk-margin-small-left">Газоблок</span>
                </label>
              </div>
              <div class="label label__item uk-margin-small-bottom">
                <label>
                  <input class="uk-checkbox" type="checkbox" :value="3" name="materials" v-model="filterTools.materials">
                  <span class="uk-margin-small-left">Керамический блок</span>
                </label>
              </div>
              <div class="label label__item uk-margin-small-bottom">
                <label>
                  <input class="uk-checkbox" type="checkbox" :value="4" name="materials" v-model="filterTools.materials">
                  <span class="uk-margin-small-left">Керамзитоблок</span>
                </label>
              </div>
              <div class="label label__item uk-margin-small-bottom">
                <label>
                  <input class="uk-checkbox" type="checkbox" :value="5" name="materials" v-model="filterTools.materials">
                  <span class="uk-margin-small-left">Пеноблок</span>
                </label>
              </div>
            </div>
          </div>
    ...
    <div class="uk-margin-top uk-position-relative z-index-10 uk-visible@m">
      <div class="cl-dark uk-grid uk-grid-small uk-margin-auto-vertical fs14">
        <template v-if="filterTools.materials.length && filterTools.materials.length !== 6">
    ...
    <form @submit.prevent="$store.dispatch('GET_PROJECTS', filterTools)" class="uk-grid uk-grid-small uk-margin-top uk-position-relative z-index-10">
      ...
      <div class="uk-flex uk-between cl-wh cr-pointer uk-width-1-1 uk-hidden@s">
          ...
          <button class="btn uk-margin-right btn__tpl3 fnt-semi btn__green fs18 uk-width-1-2">Найти</button>
      ...
      <div class="canvas-filter__wrapper uk-offcanvas-bar uk-background-muted trans4 uk-width-1-1 uk-position-relative uk-height-1-1 uk-box-shadow-large">
        ...
        <div class="nav-dark filter__nav">
          ...
          <div class="uk-text-center uk-margin-top uk-margin-bottom">
            <button class="btn btn__tpl1 btn__green" @click="formSubmitMobile">
              Применить фильтр
            </button>
          </div>
...
export default {
  ...
  created() {
    ...
    this.$watch('filterTools.materials', (v) => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('filterTools.mansard', () => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('filterTools.floors', (v) => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('filterTools.rooms', () => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('filterTools.garage_type', () => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('filterTools.basement', () => {
      this.$store.dispatch('GET_PROJECTS', this.filterTools)
    })

    this.$watch('$store.state.filterTools.sort', (v) => {
      this.filterTools.sort = v
    })
  },
  methods: {
    formSubmitMobile(){
    ...
    scrollToProject(){
        document.getElementById('projectsContainer').scrollTo({
          top: -100,
          behavior: "smooth"
        });
      },
